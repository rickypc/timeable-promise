...
describe('example.ts', () => {
  ...
  test.concurrent('runs the example and returns the expected string', async () => {
    ...
    expect(spy).toHaveBeenNthCalledWith(1, '1. Chunk ->', [
      [1, 2],
      [3, 4],
    ]);
